...
const initialReviews: Review[] = [
  ...
  { id: "2", name: "Ayesha Khan", country: "Lahore, Pakistan", message: "SEO content boosted our site traffic significantly.", rating: 4, service: "SEO Content", date: "2025-04-20", timestamp: new Date("2025-04-20").getTime() },
  ...
  { id: "5", name: "Muhammad Ali", country: "Lahore, Pakistan", message: "Editing service polished my manuscript beautifully.", rating: 5, service: "Editing", date: "2025-01-30", timestamp: new Date("2025-01-30").getTime() },
  ...
  { id: "8", name: "Fatima Ahmed", country: "Lahore, Pakistan", message: "Copywriting was persuasive and effective.", rating: 4, service: "Copywriting", date: "2024-10-10", timestamp: new Date("2024-10-10").getTime() },
  ...
  { id: "11", name: "Hassan Raza", country: "Lahore, Pakistan", message: "SEO content was well-researched.", rating: 4, service: "SEO Content", date: "2024-07-20", timestamp: new Date("2024-07-20").getTime() },
  ...
  { id: "14", name: "Zainab Malik", country: "Lahore, Pakistan", message: "Website content was user-friendly.", rating: 4, service: "Website Content", date: "2024-04-30", timestamp: new Date("2024-04-30").getTime() },
  ...
  { id: "18", name: "Bilal Sheikh", country: "Lahore, Pakistan", message: "Copywriting was compelling!", rating: 4, service: "Copywriting", date: "2023-12-25", timestamp: new Date("2023-12-25").getTime() },
  ...
  { id: "21", name: "Sana Iqbal", country: "Lahore, Pakistan", message: "SEO content was keyword-rich.", rating: 4, service: "SEO Content", date: "2023-09-20", timestamp: new Date("2023-09-20").getTime() },
  ...
  { id: "34", name: "Zara Ali", country: "Lahore, Pakistan", message: "Website content was engaging.", rating: 4, service: "Website Content", date: "2022-09-30", timestamp: new Date("2022-09-30").getTime() },
  ...
  { id: "37", name: "Hina Butt", country: "Lahore, Pakistan", message: "Blog posts were well-written.", rating: 5, service: "Blog Writing", date: "2022-06-10", timestamp: new Date("2022-06-10").getTime() },
  ...
  { id: "40", name: "Saba Qureshi", country: "Lahore, Pakistan", message: "Editing was thorough.", rating: 5, service: "Editing", date: "2022-03-15", timestamp: new Date("2022-03-15").getTime() },
  ...
  { id: "43", name: "Asadullah Khan", country: "Lahore, Pakistan", message: "Copywriting was impactful.", rating: 4, service: "Copywriting", date: "2021-12-25", timestamp: new Date("2021-12-25").getTime() },
  ...
  { id: "46", name: "Amir Hussain", country: "Lahore, Pakistan", message: "SEO content was effective.", rating: 4, service: "SEO Content", date: "2021-09-20", timestamp: new Date("2021-09-20").getTime() },
